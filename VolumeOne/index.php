	...
	<div class="content" style="margin-left: 300px; padding: 2px 16px; position: absolute;">
		...
		<div class="title">
			...
			<?php if (isset($_SESSION['username'])): ?>
				...
				<p style="font-size: 18px; margin-top: 20px; margin-left: 10px; height: 100%;">Welcome <strong><?php echo $_SESSION['username']; ?></strong>! Are you ready to dive into the English world? Here you will find lessons with specialized theory and tests to evaluate yourself.
				</p>
